...
tuos_interfaces__msg__Num__create()
{
  ...
  tuos_interfaces__msg__Num * msg = (tuos_interfaces__msg__Num *)allocator.allocate(sizeof(tuos_interfaces__msg__Num), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tuos_interfaces__msg__Num));
  bool success = tuos_interfaces__msg__Num__init(msg);
  if (!success) {
...
tuos_interfaces__msg__Num__destroy(tuos_interfaces__msg__Num * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tuos_interfaces__msg__Num__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tuos_interfaces__msg__Num__Sequence__init(tuos_interfaces__msg__Num__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tuos_interfaces__msg__Num * data = NULL;

  if (size) {
    data = (tuos_interfaces__msg__Num *)allocator.zero_allocate(size, sizeof(tuos_interfaces__msg__Num), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tuos_interfaces__msg__Num__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tuos_interfaces__msg__Num__fini(&data[i - 1]);
      }
...
tuos_interfaces__msg__Num__Sequence__fini(tuos_interfaces__msg__Num__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tuos_interfaces__msg__Num__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tuos_interfaces__msg__Num__Sequence * array = (tuos_interfaces__msg__Num__Sequence *)allocator.allocate(sizeof(tuos_interfaces__msg__Num__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tuos_interfaces__msg__Num__Sequence__init(array, size);
  if (!success) {
...
tuos_interfaces__msg__Num__Sequence__destroy(tuos_interfaces__msg__Num__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tuos_interfaces__msg__Num__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tuos_interfaces__msg__Num__Sequence__are_equal(const tuos_interfaces__msg__Num__Sequence * lhs, const tuos_interfaces__msg__Num__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tuos_interfaces__msg__Num__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tuos_interfaces__msg__Num__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tuos_interfaces__msg__Num);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tuos_interfaces__msg__Num * data =
      (tuos_interfaces__msg__Num *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tuos_interfaces__msg__Num__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tuos_interfaces__msg__Num__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tuos_interfaces__msg__Num__copy(
