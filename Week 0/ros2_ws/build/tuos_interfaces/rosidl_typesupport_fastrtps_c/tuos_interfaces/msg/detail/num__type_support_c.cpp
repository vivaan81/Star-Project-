...
#include "tuos_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
using _Num__ros_msg_type = tuos_interfaces__msg__Num;
...
size_t get_serialized_size_tuos_interfaces__msg__Num(
  const void * untyped_ros_message,
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tuos_interfaces__msg__Num(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tuos_interfaces
size_t max_serialized_size_tuos_interfaces__msg__Num(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tuos_interfaces__msg__Num;
    is_plain =
      (
...
static size_t _Num__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tuos_interfaces__msg__Num(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuos_interfaces, msg, Num)() {
