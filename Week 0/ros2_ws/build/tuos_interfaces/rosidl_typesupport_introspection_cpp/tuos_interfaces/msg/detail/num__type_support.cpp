...
{
  new (message_memory) tuos_interfaces::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tuos_interfaces::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[1] = {
  {
    ...
    offsetof(tuos_interfaces::msg::Num, num),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  "tuos_interfaces::msg",  // message namespace
  "Num",  // message name
  1,  // number of fields
  sizeof(tuos_interfaces::msg::Num),
...
{
  return &::tuos_interfaces::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tuos_interfaces, msg, Num)() {
  return &::tuos_interfaces::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
