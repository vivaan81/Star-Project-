...
static const _Example_type_support_symbol_names_t _Example_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, part1_pubsub, msg, Example)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, part1_pubsub, msg, Example)),
  }
};
...
{
  return &::part1_pubsub::msg::rosidl_typesupport_cpp::Example_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, part1_pubsub, msg, Example)() {
  return get_message_type_support_handle<part1_pubsub::msg::Example>();
}
