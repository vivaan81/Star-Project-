...
bool part1_pubsub__msg__example__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("part1_pubsub.msg._example.Example", full_classname_dest, 33) == 0);
  }
  part1_pubsub__msg__Example * ros_message = _ros_message;
  {  // info
...
PyObject * part1_pubsub__msg__example__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("part1_pubsub.msg._example");
